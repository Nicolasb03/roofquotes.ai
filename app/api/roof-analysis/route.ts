...
function processGoogleSolarResponse(buildingData: any, address: string, coordinates: { lat: number; lng: number }) {
...
function generateRealisticFallbackData(address: string, coordinates: { lat: number; lng: number } | null) {
