  ...
  return (
    <html lang="en">
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-KJBTB7MG');
            `
          }}
        />
        ...
        <noscript>
          <img 
            ...
            width="1" 
            style={{display:'none'}}
            src="https://www.facebook.com/tr?id=1516202722651792&ev=PageView&noscript=1"
          />
        </noscript>
        {/* End Meta Pixel Code */}
      </head>
      <body className={inter.className}>
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-KJBTB7MG"
            height="0" 
            width="0" 
